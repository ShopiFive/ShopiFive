...
export default function VisionStatement() {
    ...
    return (
        <div className="mission-statement" style={{ backgroundColor: "#FFFFFF" }}>
            ...
            <p>What impact do you envision your business having on the world? Phrase the impact as an assertion—begin the statement with “[My company] will… or To…” and you’ll be off to a great start.</p>
            ...
            <br />
            <p className="subdued">Need more help? Here's a clip from our Learn With Shopify YouTube channel:</p>
            <VideoThumbnail
                videoLength={80}
